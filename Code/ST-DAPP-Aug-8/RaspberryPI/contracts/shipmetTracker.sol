...
contract ShipmentTracker {
    ...
    event ShippingEvent(address _shipper,uint _data,string _datatID,string _location,string _trackingNr,string _status,uint _blockNr,uint _timestamp);

    event ReqViolationEventMinMax(address _shAddr, string _trackingNr,string _reqID,string _title,uint _severityLevel,uint _sensorData,string _violationLoc,uint _minThreshold,uint _maxThreshold,uint _blkNr,uint _timeStamp);
    event ReqViolationEventMax(address _shAddr, string _trackingNr,string _reqID,string _title,uint _severityLevel,uint _sensorData,string _violationLoc,uint _maxThreshold,uint _blkNr,uint _timeStamp);
    event ReqViolationEventMin(address _shAddr, string _trackingNr,string _reqID,string _title,uint _severityLevel,uint _sensorData,string _violationLoc,uint _minThreshold,uint _blkNr,uint _timeStamp);
    ...
    */
    ...
    function getTrackingData(uint data, string dataID, string location, string trackingNr, string _status, string _shipperID, string _seed) internal returns(ShipmentData d) {
    ...
    */
    ...
    /**
      ...
      callebale by: only authorized handlers
    */
    function GetLoggedData(uint index,string trackingNr) public constant onlyAuthorized(trackingNr) returns(address _shAddress,uint _sensorData,string _dataID,string _location,string _status,uint _blkNr,uint _timeStamp) {
